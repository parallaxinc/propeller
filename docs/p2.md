...
Early Adopter Series - Presentations and discussion around programming tools, languages, hardware, applications, code examples, and projects of all kinds.  Learn, lurk, and ask questions.
  ...
  * Next on schedule: 
    * [Visual Programming with Touch Logic Control (TLC) and TAQOZ with James Caska](https://www.parallax.com/company/event/3434/visual-programming-touch-logic-control-tlc-and-taqoz) - July 08
