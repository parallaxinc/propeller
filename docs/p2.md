...
|[PNut v34xb (required for debugging)][PNutV34]|[Chat Log](assets/Presentations/P2F6_ChatLog.txt)|[Chat Log](assets/Presentations/P2F7_ChatLog.txt)|[Chat Log](assets/Presentations/P2F8_ChatLog.txt)|
...
|[Chat Log](assets/Presentations/P2F9_ChatLog.txt)|[Chat Log](assets/Presentations/P2F10_ChatLog.txt)|[Chat Log](assets/Presentations/P2F11_ChatLog.txt)|[Chat Log](assets/Presentations/P2F12_ChatLog.txt)|
|||[Presentation Slide Deck (PDF)](https://github.com/parallaxinc/propeller/releases/download/P2_Live_11/P2F11_Tao-of-Spin2-Programming_Slides.pdf)||
...
[P2F13]: https://youtu.be/nYLkaZC0cGc?list=PLt_MJJ1F_EXa25_TWa4Sdi77daQaxA_ZU&t=6 "Audio Effects Processing on the P2 - Chip Gracey - Sep 9th"
  ...
  * ### IDEs
    * #### Spin2 & PASM2
      - Propeller Tool - Parallax P1 & P2 IDE (built for Windows)
        - [Propeller Tool v2.3.0.0 Alpha (09/03/20)](https://www.parallax.com/downloads/propeller-tool-software-windows-spin-assembly) - for P2 Rev B/C (2nd/3rd -ES silicon) [3rd is slated as production version] as used on the Rev B and Rev C P2 Eval boards
      - PNut - Parallax P2 IDE (built for Windows- can be used with wine on Linux and MacOS)
        - [PNut v34xb][PNutV34] - (signed) for P2 Rev B/C (2nd/3rd ES silicon) [3rd is slated as production version] as used on the Rev C P2 Eval boards.  Graphical DEBUG bitmap and FFT windows added. Bug from v34i fixed: object array methods now compile as terms.  See [P2 Spin2 Launguage][P2SpinDoc] documentation's DEBUG details
...
[PNutV34]: https://github.com/parallaxinc/propeller/releases/download/PNut_v34xb/PNut_v34xb.zip "PNut v34xb"