...
Early Adopter Series - Presentations and discussion around programming tools, languages, hardware, applications, code examples, and projects of all kinds.  Learn, lurk, and ask questions.
  * Watch recorded sessions:
    ...
    * [Multi-language Development with fastspin/flexgui by Eric R. Smith](https://www.youtube.com/watch?v=M8OYUDcgV_8&list=PLt_MJJ1F_EXa25_TWa4Sdi77daQaxA_ZU&index=4&t=0s) - July 01
      * [<img src="assets/Presentations/P2F3_Multi-Language.jpg" alt="Multi-Language Coding" height="101" width="150">](https://www.youtube.com/watch?v=M8OYUDcgV_8&list=PLt_MJJ1F_EXa25_TWa4Sdi77daQaxA_ZU&index=4&t=0s)
      * [Presentation Slide Deck (PDF)](https://github.com/parallaxinc/propeller/releases/download/P2_Live_3/Multi-language.Programming.on.the.P2.with.fastspin.and.FlexGUI.pdf)
    * [Visual Programming with Touch Logic Control (TLC) and TAQOZ with James Caska](https://youtu.be/b772b8cZnLg?list=PLt_MJJ1F_EXa25_TWa4Sdi77daQaxA_ZU&t=20) - July 08
      * [<img src="assets/Presentations/P2F4_TouchLogicControl.jpg" alt="Visual Programming with Touch Logic Control" height="77" width="150">](https://youtu.be/b772b8cZnLg?list=PLt_MJJ1F_EXa25_TWa4Sdi77daQaxA_ZU&t=20)
      * [Virtual Breadboard website](http://www.virtualbreadboard.com/)
    * [Spin2/PASM2 Debug with Runtime Expression Reporting by Chip Gracey](https://youtu.be/O4XnlnsiD8k?list=PLt_MJJ1F_EXa25_TWa4Sdi77daQaxA_ZU&t=39) - July 15
      * [<img src="assets/Presentations/P2F5_DebugExpressionReporting.jpg" alt="Spin2/PASM2 Debug with Runtime Expression Reporting" height="77" width="150">](https://youtu.be/O4XnlnsiD8k?list=PLt_MJJ1F_EXa25_TWa4Sdi77daQaxA_ZU&t=39)
      * [PNut v34ta (required for debugging)](https://github.com/parallaxinc/propeller/releases/download/PNut_v34ta/PNut_v34ta.zip)
...
* Added Jon "JonnyMac" McPhalen's object [dmx tx](https://github.com/parallaxinc/propeller/tree/master/libraries/community/p2/All/jm_dmx_tx) (DMX 512 protocol)
