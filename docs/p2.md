...
|[Testing Hardware<br/>with TAQOZ in ROM][P2F1]|[Display, GUI, and<br/>Multimedia Options][P2F2]|[FastSpin Multi-language<br/>Development][P2F3]|
|:----------------------------------------:|:------------------------------------------:|:-----------------------------------------:|
...
|[Visual Programming<br/>with Touch Logic Control][P2F4]|[Spin2/PASM2 Debug<br/>with Runtime Expression][P2F5]|[MicroPython for the P2][P2F6]|
|:-------------------------------------------------:|:-----------------------------------------------:|:----------------------------:|
...
|[Virtual Breadboard website](http://www.virtualbreadboard.com/)|[PNut v34xb (required for debugging)][PNutV34]|[Chat Log](assets/Presentations/P2F6_ChatLog.txt)|
...
|  [P2D2 Module][P2F7]  |  [C Programming the P2][P2F8]  |[Graphical Debug<br/>with Spin2][P2F9] |        [Smart Pins][P2F10]         | [Tao of Spin2<br/>Programming][P2F11] |
|:---------------------:|:------------------------------:|:---------------------------------:|:----------------------------------:|:---------------------------------:|
| [Peter Jakacki][P2F7] |       [Eric Smith][P2F8]       |        [Chip Gracey][P2F9]        |   [Chip Gracey & Jon Titus][P2F10] |       [Jon McPhalen][P2F11]       |
|[<img src="assets/Presentations/P2F7_P2D2Module.jpg" alt="Peter Jakacki Presents the P2D2 Module - Jul 29th" height="95" width="150">][P2F8]|[<img src="assets/Presentations/P2F8_CProgrammingP2.jpg" alt="C Programming the P2 - Aug 6th" height="112" width="150">][P2F8]|[<img src="assets/Presentations/P2F9_GraphicalDebug.jpg" alt="Graphical Debug with Spin2 - Aug 12th" height="116" width="150">][P2F9]|[<img src="assets/Presentations/P2F10_SmartPins.jpg" alt="Smart Pins with Chip Gracey and Jon Titus - Aug 19th" height="131" width="150">][P2F10]|[<img src="assets/Presentations/P2F11_TaoSpin2.jpg" alt="Tao of Spin2 Programming - Aug 26th" height="79" width="150">][P2F11]|
|[Chat Log](assets/Presentations/P2F7_ChatLog.txt)|[Chat Log](assets/Presentations/P2F8_ChatLog.txt)|[Chat Log](assets/Presentations/P2F9_ChatLog.txt)|[Chat Log](assets/Presentations/P2F10_ChatLog.txt)|[Chat Log](assets/Presentations/P2F11_ChatLog.txt)|
...
[P2F11]: https://youtu.be/MfiX-UqGXVg?list=PLt_MJJ1F_EXa25_TWa4Sdi77daQaxA_ZU&t=98 "Tao of Spin2 Programming - Jon McPhalen - Aug 26th"
  ...
  * Next on schedule: 
    * [Propeller Tool and Wi-Fi Adapter for P2 Eval](https://parallax.us19.list-manage.com/track/click?u=0234d4a511fd7724a797df3d3&id=3733838f39&e=46d6bc6c57) - Jeff Martin & Michael Mulholland - Sep 2nd
