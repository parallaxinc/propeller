  ...
  * Propeller 2 Live Forums - Early Adopter Series - Presentations and discussion around programming tools, languages, hardware, applications, code examples, and projects of all kinds.  Learn, lurk, and ask questions.
    * Watch recorded sessions:
      * [Testing Hardware with TAQOZ in ROM - Peter Jakacki and Ray Rodrick](https://www.youtube.com/watch?v=DfDaXcbk-dY&list=PLt_MJJ1F_EXa25_TWa4Sdi77daQaxA_ZU&index=2&t=0s) - June 18
        * [<img src="assets/Presentations/P2F1_Testing_Hardware_with_TAQOZ.jpg" alt="P2 Testing Hardware with TAQOZ" height="150" width="170">](https://www.youtube.com/watch?v=DfDaXcbk-dY&list=PLt_MJJ1F_EXa25_TWa4Sdi77daQaxA_ZU&index=2&t=0s)
      * [Display, GUI, and Multimedia Options with the Propeller 2 with Raymond Allen, PhD EE](https://www.youtube.com/watch?v=wmzQY6SayQE&list=PLt_MJJ1F_EXa25_TWa4Sdi77daQaxA_ZU&index=3&t=0s) - June 24
        * [<img src="assets/Presentations/P2F2_Display_GUI_MultiP2F2_media.jpg" alt="P2 Display Examples" height="150" width="112">](https://www.youtube.com/watch?v=wmzQY6SayQE&list=PLt_MJJ1F_EXa25_TWa4Sdi77daQaxA_ZU&index=3&t=0s)
