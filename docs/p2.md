...
Early Adopter Series - Presentations and discussion around programming tools, languages, hardware, applications, code examples, and projects of all kinds.  Learn, lurk, and ask questions.
  * Watch recorded sessions:
    ...
    * [Multi-language Development with fastspin/flexgui](https://www.youtube.com/watch?v=M8OYUDcgV_8&list=PLt_MJJ1F_EXa25_TWa4Sdi77daQaxA_ZU&index=4&t=0s) - July 01
  ...
  * Next on schedule: 
    * [Spin 2 Debug with Runtime Expression Reporting](https://www.parallax.com/company/event/3433/spin-2-debug-runtime-expression-reporting) with Chip Gracey - July 15
      * [PNut v34t (required for debugging)](https://github.com/parallaxinc/propeller/releases/download/PNut_v34t/PNut_v34t.zip)
