...
|[Chat Log](assets/Presentations/P2F7_ChatLog.txt)|[Chat Log](assets/Presentations/P2F8_ChatLog.txt)|[Chat Log](assets/Presentations/P2F9_ChatLog.txt)|
  ...
  * ### IDEs
    * #### Spin2 & PASM2
      ...
      - PNut - Parallax P2 IDE (built for Windows- can be used with wine on Linux and MacOS)
        - [PNut v34wb][PNutV34wb] - (signed) for P2 Rev B/C (2nd/3rd ES silicon) [3rd is slated as production version] as used on the Rev C P2 Eval boards.  Supports additional debugging with textual and visual displays.  See [P2 Spin2 Launguage][P2SpinDoc] documentation's DEBUG details
...
[PNutV34wb]: https://github.com/parallaxinc/propeller/releases/download/PNut_v34wb/PNut_v34wb.zip "PNut v34wb"