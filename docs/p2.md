...
|[Virtual Breadboard website](http://www.virtualbreadboard.com/)|[PNut v34wb (required for debugging)][PNutV34]|[Chat Log](assets/Presentations/P2F6_ChatLog.txt)|
...
|  [P2D2 Module][P2F7]  |  [C Programming the P2][P2F8]  |[Graphical Debug with Spin2][P2F9] |   [Smart Pins][P2F10]  |
|-----------------------|--------------------------------|-----------------------------------|-----------------------|
| [Peter Jakacki][P2F7] |       [Eric Smith][P2F8]       |        [Chip Gracey][P2F9]        |   [Chip Gracey & Jon Titus][P2F10] |
|[<img src="assets/Presentations/P2F7_P2D2Module.jpg" alt="Peter Jakacki Presents the P2D2 Module - Jul 29th" height="95" width="150">][P2F8]|[<img src="assets/Presentations/P2F8_CProgrammingP2.jpg" alt="C Programming the P2 - Aug 6th" height="112" width="150">][P2F8]|[<img src="assets/Presentations/P2F9_GraphicalDebug.jpg" alt="Graphical Debug with Spin2 - Aug 12th" height="116" width="150">][P2F9]|[<img src="assets/Presentations/P2F10_SmartPins.jpg" alt="Smart Pins with Chip Gracey and Jon Titus - Aug 19th" height="131" width="150">][P2F10]|
|[Chat Log](assets/Presentations/P2F7_ChatLog.txt)|[Chat Log](assets/Presentations/P2F8_ChatLog.txt)|[Chat Log](assets/Presentations/P2F9_ChatLog.txt)|[Chat Log](assets/Presentations/P2F10_ChatLog.txt)|
...
[P2F10]: https://www.youtube.com/watch?v=PhkGA1FMPUc&list=PLt_MJJ1F_EXa25_TWa4Sdi77daQaxA_ZU&index=13&t=0s "Smart Pins with Chip Gracey and Jon Titus"

  * Next on schedule: 
    * [Tao of Spin2 Programming](https://us02web.zoom.us/meeting/register/tZ0qdu-qrT8uEtc2rc5tsfwonaXr3Lm3sZGy) - JonnyMac - Aug 26th
  ...
  * ### IDEs
    * #### Spin2 & PASM2
      ...
      - PNut - Parallax P2 IDE (built for Windows- can be used with wine on Linux and MacOS)
        - [PNut v34wb][PNutV34] - (signed) for P2 Rev B/C (2nd/3rd ES silicon) [3rd is slated as production version] as used on the Rev C P2 Eval boards.  Supports additional debugging with textual and visual displays.  See [P2 Spin2 Launguage][P2SpinDoc] documentation's DEBUG details
...
[PNutV34]: https://github.com/parallaxinc/propeller/releases/download/PNut_v34wb/PNut_v34wb.zip "PNut v34wb"