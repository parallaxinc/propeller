...
|[Testing Hardware with TAQOZ in ROM][P2F1]|[Display, GUI, and Multimedia Options][P2F2]|[Multi-language Development][P2F3]|
|------------------------------------------|--------------------------------------------|-|
| [by Peter Jakacki and Ray Rodrick][P2F1] |      [by Raymond Allen, PhD EE][P2F2]      |[with fastspin/flexgui by Eric R. Smith][P2F3]|
|            [June 18][P2F1]               |              [June 24][P2F2]               |[July 01][P2F3]|
...
||[Presentation Slide Deck (PDF)](https://github.com/parallaxinc/propeller/releases/download/P2_Live_2/Display.GUI.and.Multimedia.options.with.P2.rev.b.pdf)|[Presentation Slide Deck (PDF)](https://github.com/parallaxinc/propeller/releases/download/P2_Live_3/Multi-language.Programming.on.the.P2.with.fastspin.and.FlexGUI.pdf)|

---

|[Visual Programming with Touch Logic Control][P2F4]|[Spin2/PASM2 Debug with Runtime Expression][P2F5]|
|---------------------------------------------------|----------------------------------------|
|       [and TAQOZ with James Caska][P2F4]          |     [Reporting by Chip Gracey][P2F5]   |
|               [July 08][P2F4]                     |              [July 15][P2F5]           |
|[<img src="assets/Presentations/P2F4_TouchLogicControl.jpg" alt="Visual Programming with Touch Logic Control" height="77" width="150">][P2F4]|[<img src="assets/Presentations/P2F5_DebugExpressionReporting.jpg" alt="Spin2/PASM2 Debug with Runtime Expression Reporting" height="77" width="150">][P2F5]|
|[Virtual Breadboard website](http://www.virtualbreadboard.com/)|[PNut v34ta (required for debugging)](https://github.com/parallaxinc/propeller/releases/download/PNut_v34ta/PNut_v34ta.zip)|
||[P2 Spin2 Documentation](https://docs.google.com/document/d/16qVkmA6Co5fUNKJHF6pBfGfDupuRwDtf-wyieh_fbqw/edit?usp=sharing) - See DEBUG information|


[P2F1]: https://www.youtube.com/watch?v=DfDaXcbk-dY&list=PLt_MJJ1F_EXa25_TWa4Sdi77daQaxA_ZU&index=2&t=0s "Testing Hardware with TAQOZ in ROM - Peter Jakacki and Ray Rodrick"
[P2F2]: https://www.youtube.com/watch?v=wmzQY6SayQE&list=PLt_MJJ1F_EXa25_TWa4Sdi77daQaxA_ZU&index=3&t=0s "Display, GUI, and Multimedia Options with the Propeller 2 with Raymond Allen, PhD EE"
[P2F3]: https://www.youtube.com/watch?v=M8OYUDcgV_8&list=PLt_MJJ1F_EXa25_TWa4Sdi77daQaxA_ZU&index=4&t=0s "Multi-language Development with fastspin/flexgui by Eric R. Smith"
[P2F4]: https://youtu.be/b772b8cZnLg?list=PLt_MJJ1F_EXa25_TWa4Sdi77daQaxA_ZU&t=20 "Visual Programming with Touch Logic Control (TLC) and TAQOZ with James Caska"
[P2F5]: https://youtu.be/uywWA1Sk1L0?list=PLt_MJJ1F_EXa25_TWa4Sdi77daQaxA_ZU&t=40 "Spin2/PASM2 Debug with Runtime Expression Reporting by Chip Gracey"

  * Next on schedule: 
    * [Native P2 MicroPython with Team Oz](https://us02web.zoom.us/meeting/register/tZ0kc-qopzovH9KIFf8yAVt9tdxguKNC1tqy) - July 22
    * Smart Pin Documentation with Jon Titus - TBD
